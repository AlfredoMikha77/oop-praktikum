...
public class GUI_BangunDatar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "L.Persegi Panjang", "L.Lingkaran"}));
...
LuasPanjangPersegi ppanjang = new LuasPanjangPersegi();
...
private int Luas(int panjang, int lebar) {
    ...
    if (selectedShape.equals("Lingkaran")) {
        ...
        TxtLebar.setEnabled(false);
    } else if (selectedShape.equals("Persegi Panjang")) {
        TXT1.setText("Panjang");
